...
data=csvread("1_first_norm_few_languages.csv");
h=bar3(data,0.5)
...
set(gca,'xtick',[1:5],'xticklabel',{'Arabic','Dutch','Korean', 'Polish', 'Romanian'})
set(gca,'ytick',[1:5],'yticklabel',{'Arabic','Dutch','Korean', 'Polish', 'Romanian'})
