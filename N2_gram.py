...
#     with open(os.path.dirname(__file__)+"\\csv_N2gram\\"+language+'.csv', 'w',newline='') as csvfile:
...
with open(os.path.dirname(__file__)+"\\csv_N2gram\\0_global_file.csv", 'w',newline='') as csvfile:
...
with open(os.path.dirname(__file__)+"\\csv_N2gram\\0_language_list.csv", 'w',newline='') as csvfile:
    filewriter = csv.writer(csvfile, delimiter=',', quoting=csv.QUOTE_MINIMAL)
